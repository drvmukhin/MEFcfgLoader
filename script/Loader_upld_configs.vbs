...
vWaitForCommit = Array("error: configuration check-out failed","error: commit failed","ommit complete")
vModels = Array("acx5096","acx5048","acx500","acx1100","acx1000","acx2100","acx2200","mx80","mx104","mx240","mx480","mx960","mx10003")
...
'----------------------------------------------------------------
	...
	'--------------------------------------------------------------------------------
	strLine = GetValue(10)
	strFolder =   Split(strLine, ",")(0) & "/"
	strSessionL = Split(strLine, ",")(1)
	strHostL =    Split(strLine, ",")(2) 
	strLogin =    Split(strLine, ",")(3)

	strLine = GetValue(11)
	strFolder =   Split(strLine, ",")(0) & "/"
	strSessionR = Split(strLine, ",")(1)
	strHostR =    Split(strLine, ",")(2) 
	strLogin =    Split(strLine, ",")(3)
	'-------------------------------------------------------------------------------------------
...
'			crt.quit
	...
	strHostL = Trim(Split(vSettings(10), ",")(2))
